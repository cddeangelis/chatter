// This is derived from `ratatui::Terminal`, which is licensed under the MIT
// License (Copyright (c) 2016-2022 Florian Dehau, 2023-2025 The Ratatui Developers).
// Ported from codex-rs/tui/src/custom_terminal.rs.
